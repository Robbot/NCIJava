...
public class Power3A {
	public static void main(String args[]){
		...
		// declare a variable answ which stores the user's answer to show whether she/he wants to perform another computation
		// we do not have to initialize the answ variable because we are using a do while loop (i.e. the condition is tested at the bottom of the loop after the loop body was executed once), and the problem says to allow the user to calculate the value of a number raised to the power of 2 one time, and then to ask the user whether he/she would like to perform another computation
		String answ;
		do {
		...
		} while (answ.equals("yes")); // as long as the user enters "yes" the body of the do while loop is run again
