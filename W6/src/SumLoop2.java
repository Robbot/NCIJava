...
public class SumLoop2{
	public static void main(String args[]){
		...
		// declare variables
		int i=0;
		int n; // this time we will prompt the user to provide the value for n
		int number;
		int sum;	// = 0;
		...
		System.out.println("enter a number of digits you are going to provide to be squared: ");
		...
		System.out.println("You provided me enough numbers - exiting ");
