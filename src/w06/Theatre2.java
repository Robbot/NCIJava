package w06;
/** 
Lab: Selection Statements

Practice work: Problem 6 

The theatre has now decided to charge based both on the day of the week and on the age of the customer. The new prices are outlined in
 Table 3.
...
public class Theatre2 {
	...
	// declare setter methods -- declare a setter method for each of the instance variables that can be set/ assigned a value -- input data
	...
	// declare getter methods --  declare a getter method for each of the instance variables whose values should be made available to the other classes that use this instantiable class -- output data; for example, the class with the main() method which uses this instantiable class (i.e. Theatre2App.java) would use the getter method to retrieve the price of a ticket
