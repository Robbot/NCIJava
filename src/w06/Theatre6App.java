...
Practice work: Problem 11: Theatre 6

Modify Theatre 5 to keep a running total of all tickets that the user wishes to
buy.  When the programme exits the loop, the total cost should be displayed
to the user.
