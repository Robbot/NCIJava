...
TwoDimensionalShape
	...
	-- TwoDimensionalShape is also a subclass because it inherits from AbstShape superclass.

@author adriana e chis
*/

// declare an abstract class by using the keyword abstract
// this is still an abstract class because the TwoDimensionalShape class generically describe all the two dimensional geometrical shapes, the class still cannot compute the specifics of each 2D class of geometrical figures (e.g. the area of a circle, or the perimeter of a triangle)
public abstract class TwoDimensionalShape extends AbstShape {
	...
	public TwoDimensionalShape(String shapeName){ 
		...
		description = "two dimensional shape"; // the instance variable description is available in this subclass due to inheritance
	}
